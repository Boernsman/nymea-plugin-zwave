...
ZwaveNode::ZwaveNode(QObject *parent) : QObject(parent)
{

}

quint32 ZwaveNode::homeId() const
{
    return m_homeId;
}
...
bool ZwaveNode::polled() const
{
    return m_polled;
}

quint16 ZwaveNode::deviceType() const
{
    return m_deviceType;
}

QList<ValueID> ZwaveNode::valueIds() const
{
    return m_valueIds;
}
